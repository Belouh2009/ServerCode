...
@Entity
@Table(name = "certificatccps")
public class CertificatCcps {
	...
	public CertificatCcps(String idCertificat, LocalDate dateCreation, String ajoutPar, String modifPar) {
		super();
		this.idCertificat = idCertificat;
		this.dateCreation = dateCreation;
		this.ajoutPar = ajoutPar;
