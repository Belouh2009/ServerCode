...
public class AgentCcpsDTO {
    ...
    private List<SeSituerCcpsDTO> sesituer;
	...
	public List<SeSituerCcpsDTO> getSesituer() {
		return sesituer;
	}

	public void setSesituer(List<SeSituerCcpsDTO> sesituer) {
		this.sesituer = sesituer;
	}

	public AgentCcpsDTO(String matricule, String civilite, String nom, String prenom, String enfant, String localite,
			...
			LocalDate dateDebut, LocalDate dateDernierPai, CertificatCcpsDTO certificat,
			List<SeSituerCcpsDTO> sesituer) {
		super();
		this.matricule = matricule;
		this.civilite = civilite;
		this.nom = nom;
