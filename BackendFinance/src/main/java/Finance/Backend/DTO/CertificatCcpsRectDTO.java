...
public class CertificatCcpsRectDTO {
	...
	public CertificatCcpsRectDTO(String id_certificat, LocalDate date_creation, String ajout_par, String modif_par) {
		super();
		this.id_certificat = id_certificat;
		this.date_creation = date_creation;
		this.ajout_par = ajout_par;
