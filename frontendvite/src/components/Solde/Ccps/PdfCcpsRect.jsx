                    ...
                    <Page size="A4" style={styles.page}>
                        ...
                        <View>
                            <Text style={styles.detailsTitles}>
                                Rectificatif du Certificat de Cessation de Paiement N° {data.idCertificatRect || "N/A"}
                            </Text>
                        </View>
                        ...
                        <View style={styles.section}>
                            <Text style={styles.paragraph}>
                                ...
                                que {data.civilite} {data.nom} {data.prenom}{"\n"}
                                IM : {data.matricule} Corps : {data.corps} Grade : {data.grade}{"\n"}
                                Actuellement {data.cessationService} suivant : {data.referenceActe} du {data.dateActe}{"\n"}
                                A cessé ses activités pour compter du : {data.dateCessation}{"\n"}
                                A été payé jusqu'au : {data.dateFinPai}{"\n"}
                                Sur chapitre : {data.chapitre} Article : {data.article} du BUDGET GENERAL, et sur les bases suivantes :{"\n"}
                                Indice : {data.indice} Zone : {data.zone} Enfants : {data.enfant}
                            </Text>
                        </View>
