...
export default function ContentSection({ darkTheme }) {
    ...
    const fetchAgents = async () => {
        try {
            setLoading(true);
            const response = await axios.get("http://192.168.88.53:8088/agentsCcps/all");
                ...
                }, */
        {
            ...
            render: (_, record) => (
                <div style={{ display: "flex", justifyContent: "center" }}>
                    ...
                    <Button style={{ marginLeft: "10px" }} color="cyan" variant="solid" onClick={() => handleShowRectificatifModal(record)}>
                        <FaFilePen size={15} />
                    </Button>
