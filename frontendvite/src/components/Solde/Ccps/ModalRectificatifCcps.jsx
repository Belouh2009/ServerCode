...
const ModalModifCap = ({ open, onClose, agent, onSuccess, rubriques = [] }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const newIdFormatted = `${String(newIdNum).padStart(4, "0")}-${currentYear}`;
    ...
    return (
        <Modal
            title="Réctification de Certificat de Cessation de Paiement de la Solde"
            centered
            open={open}
            onCancel={onClose}
            width={1200}
            ...
            <Row gutter={16}>
                <Col span={10} className="form-container">
                    ...
                    <Form layout="vertical">
                        ...
                        <Form.Item label="ID Cetificat" required>
