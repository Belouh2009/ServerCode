    ...
    const fetchData = async () => {
      try {
        ...
        const [corpsRes, chapitreRes, localitesRes] = await Promise.all([
          axios.get("http://192.168.88.53:8087/CorpsGradeIndice/corps"),
          axios.get("http://192.168.88.53:8087/chapitres"),
          axios.get("http://192.168.88.53:8087/localites/noms"),
        ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://192.168.88.53:8087/agentsCas/modifier/${formData.matricule}`,
        {
          method: "PUT",
