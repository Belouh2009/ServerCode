...
const ModalCreation = ({ open, onClose, formData, setFormData, formFields, setFormFields, onSuccess }) => {
  ...
  return (
    <Modal
      title={<div style={{ textAlign: "center" }}>Création de Certificat Administraif de la Solde</div>}
      centered open={open}
      onCancel={onClose} width={700}
      footer={null}>
      <Row gutter={16}>
            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                <Form.Item label="Date de fin">
                  <Input type="date" name="dateFin" value={formData.dateFin || ""} onChange={handleChangeMain} />
                </Form.Item>
              </Col>
            </Row>

            <Form.Item label="Date prise de Service">
              <Input type="date" name="datePrise" value={formData.datePrise || ""} onChange={handleChangeMain} />
            </Form.Item>
        ...
        <Col span={10} className="form-container">
          ...
          <Form layout="vertical">
            <Form.Item label="Référence Acte">
              <Input name="referenceActe" value={formData.referenceActe || ""} onChange={handleChangeMain} placeholder="Entrer la référence de l'acte" />
            </Form.Item>
