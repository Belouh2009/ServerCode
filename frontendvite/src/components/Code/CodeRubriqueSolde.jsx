...
import ModalRubrique from "./ModalRubriqueSolde";
...
const CodeRubrique = () => {
  ...
  const fetchRubriques = () => {
    setLoading(true);
    fetch("http://192.168.88.51:8087/rubriquesolde/liste")
  ...
  const sendToBackend = (data) => {
    fetch("http://192.168.88.51:8087/rubriquesolde/import", {
      method: "POST",
  ...
  return (
    ...
    >
      ...
      >
        Liste des Codes Rubriques Solde
      </Title>
