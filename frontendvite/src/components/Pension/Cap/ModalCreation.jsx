...
import ReactSelect from "react-select"; // Importer ReactSelect
import { IoMdClose, IoMdAdd } from "react-icons/io";
import Swal from "sweetalert2"; // Correct importation
import '../../../index.css';
const ModalCreation = ({ open, onClose, formData, setFormData, formFields, setFormFields, onSuccess }) => {
    ...
    return (
        <Modal
            title={<div style={{ textAlign: "center" }}>Création de Certificat Administratif de la Pension</div>}
            centered
            open={open}
            onOk={onClose}
            onCancel={onClose}
            ...
            footer={null} // Ajouter cette ligne pour supprimer les boutons "Annuler" et "Ok"
        >
            <Row gutter={16}>
                {/* Colonne gauche - Informations de l'agent */}
...
>
  ...
  />
                ...
                {/* Colonne droite - Informations Rubrique */}
                <Col span={11} className="form-container">
