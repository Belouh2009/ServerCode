    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://192.168.88.53:8088/agents/modifier/${agent.key}`,  // Utilise 'key' dans l'URL
                updatedAgentData,
                        ...
                        <Row key={index} gutter={8} style={{ marginTop: "10px" }}>
                            <Col span={9}>
                                <Form.Item label="Rubrique">
                                    <ReactSelect
                                        name="rubrique"
                                        value={field.rubrique ? { value: field.rubrique, label: field.rubrique } : null}  // Utilisation de l'ID comme valeur
