                    ...
                    <Page key={i} size="A4" style={styles.page}>
                        ...
                        <View style={styles.section}>
                            <Text style={styles.paragraph}>
                                ...
                                que {data.civilite} {data.nom} {data.prenom} est titulaire de la Pension n° {data.num_pension},
                                servie par la {data.caisse}, assignée payable à {data.assignation}, et s'élevant mensuellement
